...
INSERT INTO transfer(sender_username, recipient_username, amount, status, message)
VALUES ('bob', 'user', 50.00, 'approved', 'Happy Birthday my Brother in Christ'),
 ('user', 'bob', 100.00, 'approved', 'Hi Eric(or Thwin or whoever) You deserve this!');
